...
Before using JOD you need to install the current Windows or Linux version of J.\footnote{JOD runs on 
...
\begin{enumerate}
	...
	\item To run JOD labs\index{labs} you must download and install the\index{Addon}
...
\begin{figure}[htbp]
  ...
  \hfill
  \subfigure[J \texttt{7.0x} Linux]{
    \label{epsj7folders}
    \includegraphics[width=0.7\textwidth]{j7folders}}
\caption[JOD Folders]{The following folder configuration\index{configuration!J folders} is recommended for running all JOD labs and test scripts.  When defining JOD folders the full path, including the drive letter on Windows and a
