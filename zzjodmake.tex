...
\AlertTok{>..>}\NormalTok{s}\DecValTok{\_\_}\NormalTok{MK}\DecValTok{\_\_}\NormalTok{JODobj}\StringTok{\textquotesingle{}\textquotesingle{}}\RegionMarkerTok{)}\NormalTok{\textquotesingle{}}\KeywordTok{,}\NormalTok{tag}
...
\NormalTok{halfbits}\AlertTok{=:}\index{halfbits@\texttt{halfbits}} \KeywordTok{]} \KeywordTok{*.} \DecValTok{1} \DecValTok{0}\KeywordTok{"}\NormalTok{\_ }\KeywordTok{$\textasciitilde{}} \KeywordTok{\#}
\end{Highlighting}
\end{Shaded}
