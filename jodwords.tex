...
\subsection{\texttt{bget} --- backup get NIMP}\label{ss:bget}   
...
\hypertarget{il:nw}{\texttt{nw}} edits\index{edit!\texttt{nw}} a new explicit word in 
...
The text types \texttt{LaTeX, HTML, XML, ASCII,  BYTE, UTF8}
