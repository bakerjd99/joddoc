...
\begin{lstlisting}[frame=single,framerule=0pt]
  ...
  NB. scan all registered dictionaries listing backups and checking hashes
...
\end{enumerate}
    ...
    More examples of the use of comment tags can be found in 
     ...
     addon or by downloading \href{https://bakerjd99.wordpress.com/the-jod-page/}{\texttt{jodijs.zip}} from %point directly to box file
