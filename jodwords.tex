...
\subsection{\texttt{bget} --- backup get}\label{ss:bget}\index{backup!\texttt{bget}} 
  ...
  \hypertarget{il:bget}{\texttt{bget}} fetches objects from either the last dictionary backup or particular backups.
...
\begin{lstlisting}[frame=single,framerule=0pt]
  ...
  NB. define word backups in locale oldstuff
  'rc dtab'=. bget <;._1 ' us.12 poor.10 little.08 words.08 lastback'
\end{lstlisting}
...
\end{verbatim}
  ...
  form this script is about 212 kilobytes when squeezed with
  \texttt{compj} it shrinks to about 75 kilobytes.
...
\begin{lstlisting}[frame=single,framerule=0pt]
  ...
  ed ; 1 { 4 get }. 4 1 21 dnl 'build'
  ed ; 1 { bget <;._1 ' me.12 me.09 me.08 me.02'
\end{lstlisting} 
