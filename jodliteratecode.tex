...
\CommentTok{NB.}
\CommentTok{NB. verbatim: see the following blog posts and github files}
\CommentTok{NB.}
\CommentTok{NB. https://analyzethedatanotthedrivel.org/2012/10/01/semi{-}literate{-}jod/}
\CommentTok{NB. https://analyzethedatanotthedrivel.org/2020/02/19/more{-}j{-}pandoc{-}syntax{-}highlighting/}
\CommentTok{NB. https://github.com/bakerjd99/jacks/blob/master/jodliterate/UsingJodliterate.pdf}
\CommentTok{NB. https://github.com/bakerjd99/jacks/blob/master/jodliterate/Using\%20jodliterate.ipynb}
\CommentTok{NB.}
\CommentTok{NB. interface word(s):}
\CommentTok{NB. {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\CommentTok{NB.  THISPANDOC     {-} full pandoc path {-} use (pandoc) if on shell path}
\CommentTok{NB.  formifacetex   {-} formats hyperlinked and highlighted interface words}
\CommentTok{NB.  grplit         {-} make latex for group (y)}
\CommentTok{NB.  ifacesection   {-} interface section summary string}
\CommentTok{NB.  ifc            {-} format interface comment text}
\CommentTok{NB.  setjodliterate {-} prepare LaTeX processing {-} sets out directory writes preamble}
\CommentTok{NB.  wordlit        {-} make latex from word list (y)}
\CommentTok{NB.}
...
\CommentTok{NB. 20jun07 added (formifacetex) to interface words}
...
\CommentTok{NB. (*)=: JLTITLETEX JLOVIEWTEX JLBUILDTEX JLGRPLITTEX JLWORDLITTEX JODLiteratePreamble}
...
\NormalTok{rem assumes latex exes are on the working path}
\NormalTok{setlocal}
\NormalTok{cd }\KeywordTok{/}\NormalTok{d }\KeywordTok{\%\textasciitilde{}}\NormalTok{dp0}
...
\CommentTok{NB. word lit root tex}
\NormalTok{JLWORDLITTEX}\AlertTok{=:}\index{JLWORDLITTEX@\texttt{JLWORDLITTEX}}  \DecValTok{0} \RegionMarkerTok{: 0}

\KeywordTok{\%}\NormalTok{ Main jodliterate }\RegionMarkerTok{(}\NormalTok{wordlit}\RegionMarkerTok{)}\NormalTok{ latex file}\KeywordTok{.} 
...
\KeywordTok{\%\textbackslash{}}\NormalTok{onecolumn}
\KeywordTok{\textbackslash{}}\NormalTok{input}\KeywordTok{\{\textasciitilde{}\#\textasciitilde{}}\NormalTok{texname}\KeywordTok{\textasciitilde{}\#\textasciitilde{}}\NormalTok{code}\KeywordTok{.}\NormalTok{tex}\KeywordTok{\}}
...
\KeywordTok{\%}\NormalTok{ tightlist command for list spacing}
\KeywordTok{\textbackslash{}}\NormalTok{providecommand}\KeywordTok{\{\textbackslash{}}\NormalTok{tightlist}\KeywordTok{\}\{\%}
  \KeywordTok{\textbackslash{}}\NormalTok{setlength}\KeywordTok{\{\textbackslash{}}\NormalTok{itemsep}\KeywordTok{\}\{}\NormalTok{0pt}\KeywordTok{\}\textbackslash{}}\NormalTok{setlength}\KeywordTok{\{\textbackslash{}}\NormalTok{parskip}\KeywordTok{\}\{}\NormalTok{0pt}\KeywordTok{\}\}}
...
\KeywordTok{\%}\NormalTok{ date each page}
\KeywordTok{\textbackslash{}}\NormalTok{rfoot}\KeywordTok{\{\textbackslash{}}\NormalTok{emph}\KeywordTok{\{\textbackslash{}}\NormalTok{today}\KeywordTok{\}\}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{NB. default pandoc install location}
\NormalTok{DEFAULTPANDOC}\AlertTok{=:}\index{DEFAULTPANDOC@\texttt{DEFAULTPANDOC}} \StringTok{\textquotesingle{}"C:\textbackslash{}Program Files\textbackslash{}Pandoc\textbackslash{}pandoc"\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{NB. interface words for (jodliterate) group}
\NormalTok{IFACEWORDSjodliterate}\AlertTok{=:}\index{IFACEWORDSjodliterate@\texttt{IFACEWORDSjodliterate}} \KeywordTok{<;.}\NormalTok{\_}\DecValTok{1} \StringTok{\textquotesingle{} THISPANDOC formifacetex grplit ifacesection ifc setjodliterate wordlit\textquotesingle{}}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{NB. interface words \textbackslash{}pageref \textbackslash{}label prefix}
\NormalTok{IFCPFX}\AlertTok{=:}\index{IFCPFX@\texttt{IFCPFX}} \StringTok{\textquotesingle{}ifc:\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{NB. markdown text string that marks where generated group interface inserted}
\NormalTok{JLINSERTIFACEMD}\AlertTok{=:}\index{JLINSERTIFACEMD@\texttt{JLINSERTIFACEMD}} \StringTok{\textquotesingle{}\textasciigrave{}\{\textasciitilde{}\{insert\_interface\_md\_\}\textasciitilde{}\}\textasciigrave{}\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{NB. root words for (jodliterate) group}
\NormalTok{ROOTWORDSjodliterate}\AlertTok{=:}\index{ROOTWORDSjodliterate@\texttt{ROOTWORDSjodliterate}} \KeywordTok{<;.}\NormalTok{\_}\DecValTok{1}\NormalTok{ \textquotesingle{} DEFAULTPANDOC IFACEWORDSjodliterate ROOTWORDSjodliterate grplit sbtokens set}
\AlertTok{>..>}\NormalTok{jodliterate wordlit\textquotesingle{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{NB. full pandoc path {-} use (pandoc) if on shell path}
\hypertarget{THISPANDOC}{\NormalTok{THISPANDOC}}\AlertTok{=:}\phantomsection\label{ifc:THISPANDOC}\index{THISPANDOC@\texttt{THISPANDOC}} \StringTok{\textquotesingle{}"C:\textbackslash{}Program Files\textbackslash{}Pandoc\textbackslash{}pandoc"\textquotesingle{}}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{NB. interface word \_ character replacement}
\NormalTok{UBARSUB}\AlertTok{=:}\index{UBARSUB@\texttt{UBARSUB}} \StringTok{\textquotesingle{}\_:\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{NB. wrapped line prefix}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{charsub}\AlertTok{=:}\index{charsub@\texttt{charsub}} \DecValTok{4} \RegionMarkerTok{: 0}

\CommentTok{NB.*charsub v{-}{-} single character pair replacements.}
\CommentTok{NB.}
\CommentTok{NB. dyad:  clPairs charsub cu}
\CommentTok{NB.}
\CommentTok{NB.   \textquotesingle{}{-}\_$ \textquotesingle{} charsub \textquotesingle{}$123 {-}456 {-}789\textquotesingle{}}

\StringTok{\textquotesingle{}f t\textquotesingle{}}\KeywordTok{=.} \RegionMarkerTok{((}\KeywordTok{\#x}\RegionMarkerTok{)}\KeywordTok{$}\DecValTok{0} \DecValTok{1}\RegionMarkerTok{)}\KeywordTok{<@,\&a./.x}
\NormalTok{t }\KeywordTok{\{\textasciitilde{}}\NormalTok{ f }\KeywordTok{i.} \KeywordTok{y}
\RegionMarkerTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\hypertarget{formifacetex}{\NormalTok{formifacetex}}\AlertTok{=:}\phantomsection\label{ifc:formifacetex}\index{formifacetex@\texttt{formifacetex}} \DecValTok{3} \RegionMarkerTok{: 0}
...
\CommentTok{NB.}
\CommentTok{NB.   NB. inteface latex}
\CommentTok{NB.   formifacetex IFACEWORDSjodliterate}

\CommentTok{NB. require \textquotesingle{}jod\textquotesingle{} !(*)=. get}
...
\CommentTok{NB. using [] brackets for page references}
\NormalTok{pgrefhd}\KeywordTok{=.} \StringTok{\textquotesingle{}[\textbackslash{}pageref\{\textquotesingle{}}\KeywordTok{,}\NormalTok{IFCPFX}
\NormalTok{pgreftl}\KeywordTok{=.} \StringTok{\textquotesingle{}\}] \textquotesingle{}}

\CommentTok{NB. fetch current short descriptions !(*)=. WORD\_ajod\_ EXPLAIN\_ajod\_}
\StringTok{\textquotesingle{}rc tab\textquotesingle{}}\KeywordTok{=.} \RegionMarkerTok{(}\NormalTok{WORD\_ajod}\DecValTok{\_}\KeywordTok{,}\NormalTok{EXPLAIN\_ajod}\DecValTok{\_}\RegionMarkerTok{)}\NormalTok{ get }\KeywordTok{y}
...
\CommentTok{NB. \_ chars create problems with page and hyperref}
\NormalTok{hlwords}\KeywordTok{=.}\NormalTok{ UBARSUB}\KeywordTok{\&}\NormalTok{charsub}\KeywordTok{\&.>}\NormalTok{ words}

\CommentTok{NB. page references}
\NormalTok{pgref}\KeywordTok{=.} \RegionMarkerTok{(}\KeywordTok{<}\NormalTok{pgrefhd}\RegionMarkerTok{)} \KeywordTok{,\&.>}\NormalTok{ hlwords }\KeywordTok{,\&.>} \KeywordTok{<}\NormalTok{pgreftl}

\CommentTok{NB. set hyperlinks on words {-} colors on comments}
\NormalTok{words}\KeywordTok{=.} \RegionMarkerTok{(}\KeywordTok{<}\NormalTok{href}\RegionMarkerTok{)} \KeywordTok{,\&.>}\NormalTok{ hlwords }\KeywordTok{,\&.>} \RegionMarkerTok{(}\KeywordTok{<}\StringTok{\textquotesingle{}\}\{\textquotesingle{}}\KeywordTok{,}\NormalTok{ntok}\RegionMarkerTok{)} \KeywordTok{,\&.>} \RegionMarkerTok{(}\KeywordTok{<"}\DecValTok{1} \RegionMarkerTok{(}\KeywordTok{>}\NormalTok{words}\RegionMarkerTok{)}\KeywordTok{,"}\DecValTok{1} \StringTok{\textquotesingle{} \textquotesingle{}}\RegionMarkerTok{)} \KeywordTok{,\&.>} \KeywordTok{<}\StringTok{\textquotesingle{}\}\}\textquotesingle{}}
...
\NormalTok{tex}\KeywordTok{=.} \KeywordTok{;}\NormalTok{words }\KeywordTok{,\&.>}\NormalTok{ pgref }\KeywordTok{,\&.>}\NormalTok{ desc }\KeywordTok{,\&.>}\NormalTok{ LF}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{NB. opens and catenates boxed lists on the last axis}
\NormalTok{fuserows}\AlertTok{=:}\index{fuserows@\texttt{fuserows}} \KeywordTok{>@}\RegionMarkerTok{((}\KeywordTok{>@[} \KeywordTok{,"}\DecValTok{1} \KeywordTok{>@]}\RegionMarkerTok{)}\KeywordTok{/}\RegionMarkerTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{:}
\CommentTok{NB. require \textquotesingle{}jod\textquotesingle{} !(*)=. badrc\_ajod\_ grp jderr\_ajod\_}
...
\NormalTok{ltx}\KeywordTok{=.} \KeywordTok{x}\NormalTok{ indexwraplatex }\RegionMarkerTok{(}\NormalTok{gheadlatex }\KeywordTok{;}\NormalTok{ gbodylatex }\KeywordTok{;}\NormalTok{ gpostlatex}\RegionMarkerTok{)} \KeywordTok{y}
...
\begin{Shaded}
\begin{Highlighting}[]
\hypertarget{grplit}{\NormalTok{grplit}}\AlertTok{=:}\phantomsection\label{ifc:grplit}\index{grplit@\texttt{grplit}} \DecValTok{3} \RegionMarkerTok{: 0}
...
\KeywordTok{:}
\CommentTok{NB. require \textquotesingle{}jod\textquotesingle{} !(*)=. badrc\_ajod\_ get grp jderr\_ajod\_ ok\_ajod\_}
\KeywordTok{try.}
...
\KeywordTok{if.}\NormalTok{ badrc\_ajod}\DecValTok{\_}\NormalTok{ gdoc}\KeywordTok{=.}\NormalTok{ MACRO\_ajod}\DecValTok{\_}\NormalTok{ get group}\KeywordTok{,}\NormalTok{JLOVIEWSUFFIX }\KeywordTok{do.}
  ...
  \KeywordTok{if.} \KeywordTok{\#}\NormalTok{gdoc}\KeywordTok{=.} \KeywordTok{;\{:,>}\DecValTok{1}\KeywordTok{\{}\NormalTok{gdoc }\KeywordTok{do.}
    \CommentTok{NB. insert interface md based on IFACEWORDSgroup}
    \KeywordTok{if.} \KeywordTok{+./}\NormalTok{JLINSERTIFACEMD }\KeywordTok{E.}\NormalTok{ gdoc }\KeywordTok{do.}
\NormalTok{      gdoc}\KeywordTok{=.}\NormalTok{ group setifacesummary gdoc}
    \KeywordTok{end.}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ifacemarkd}\AlertTok{=:}\index{ifacemarkd@\texttt{ifacemarkd}} \DecValTok{3} \RegionMarkerTok{: 0}

\CommentTok{NB.*ifacemarkd v{-}{-} generate word interface markdown section.}
\CommentTok{NB.}
\CommentTok{NB. monad:  clMd =. ifacemarkd clGroupName}
\CommentTok{NB.}
\CommentTok{NB.   ifacemarkd \textquotesingle{}jodliterate\textquotesingle{}}

\NormalTok{LF}\KeywordTok{,}\StringTok{\textquotesingle{}\textasciitilde{}\textasciitilde{}\textasciitilde{}\textasciitilde{}\{ .j \}\textquotesingle{}}\KeywordTok{,}\NormalTok{LF}\KeywordTok{,}\RegionMarkerTok{(}\DecValTok{2}\NormalTok{ ifc }\KeywordTok{y}\RegionMarkerTok{)}\KeywordTok{,}\NormalTok{LF}\KeywordTok{,}\StringTok{\textquotesingle{}\textasciitilde{}\textasciitilde{}\textasciitilde{}\textasciitilde{}\textquotesingle{}}\KeywordTok{,}\NormalTok{LF}
\RegionMarkerTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\hypertarget{ifacesection}{\NormalTok{ifacesection}}\AlertTok{=:}\phantomsection\label{ifc:ifacesection}\index{ifacesection@\texttt{ifacesection}} \DecValTok{3} \RegionMarkerTok{: 0}
...
\begin{Shaded}
\begin{Highlighting}[]
\hypertarget{ifc}{\NormalTok{ifc}}\AlertTok{=:}\phantomsection\label{ifc:ifc}\index{ifc@\texttt{ifc}} \DecValTok{3} \RegionMarkerTok{: 0}

\CommentTok{NB.*ifc v{-}{-} format interface comment text.}
\CommentTok{NB.}
\CommentTok{NB. Looks up interface  words  of a  group  and formats  text for}
\CommentTok{NB. insertion into group headers and postprocessors.}
\CommentTok{NB.}
\CommentTok{NB. monad:  ifc clGroupName}
\CommentTok{NB. dyad:   iaOption ifc clGroupName}

\DecValTok{1}\NormalTok{ ifc }\KeywordTok{y}
\KeywordTok{:}
\CommentTok{NB. require \textquotesingle{}jod\textquotesingle{} !(*)=. badrc\_ajod\_ get jderr\_ajod\_ badcl\_ajod\_ badil\_ajod\_}
\KeywordTok{if.}\NormalTok{ badcl\_ajod}\DecValTok{\_} \KeywordTok{y} \KeywordTok{do.}\NormalTok{ jderr\_ajod}\DecValTok{\_} \StringTok{\textquotesingle{}invalid group name\textquotesingle{}} \KeywordTok{return.}
\KeywordTok{else.}
\NormalTok{  iface}\KeywordTok{=.} \StringTok{\textquotesingle{}IFACEWORDS\textquotesingle{}}\KeywordTok{,}\NormalTok{alltrim }\KeywordTok{y}
\KeywordTok{end.}

\KeywordTok{x=.} \KeywordTok{\{.} \KeywordTok{,x} \KeywordTok{[}\NormalTok{ msg}\KeywordTok{=.} \StringTok{\textquotesingle{}invalid ifc options\textquotesingle{}}
\KeywordTok{if.}\NormalTok{ badil\_ajod}\DecValTok{\_} \KeywordTok{x} \KeywordTok{do.}\NormalTok{ jderr\_ajod}\DecValTok{\_}\NormalTok{ msg }\KeywordTok{return.} \KeywordTok{end.}
\KeywordTok{if.} \KeywordTok{{-}.x} \KeywordTok{e.} \KeywordTok{i.}\DecValTok{3}    \KeywordTok{do.}\NormalTok{ jderr\_ajod}\DecValTok{\_}\NormalTok{ msg }\KeywordTok{return.} \KeywordTok{end.}

\CommentTok{NB. set comment style (header, postprocessor)}
\NormalTok{cpx}\KeywordTok{=.} \KeywordTok{;} \KeywordTok{x} \KeywordTok{\{} \RegionMarkerTok{(}\KeywordTok{<}\StringTok{\textquotesingle{}NB.  \textquotesingle{}}\KeywordTok{;}\StringTok{\textquotesingle{} {-} \textquotesingle{}}\RegionMarkerTok{)}\KeywordTok{,}\RegionMarkerTok{(}\KeywordTok{<}\StringTok{\textquotesingle{}NB. \textquotesingle{}}\KeywordTok{;}\StringTok{\textquotesingle{}  NB. \textquotesingle{}}\RegionMarkerTok{)}\KeywordTok{,<}\StringTok{\textquotesingle{}\textquotesingle{}}\KeywordTok{;}\StringTok{\textquotesingle{} NB. \textquotesingle{}}

\CommentTok{NB. define interface list in jod scratch locale}
\CommentTok{NB. !(*)=. SO\_\_JODobj erase\_\_SO\_\_JODobj locsfx\_ajod\_ nl\_\_SO\_\_JODobj}
\KeywordTok{if.}\NormalTok{ badrc\_ajod}\DecValTok{\_}\NormalTok{ rc}\KeywordTok{=.} \RegionMarkerTok{(}\KeywordTok{;}\NormalTok{SO}\DecValTok{\_\_}\NormalTok{JODobj}\RegionMarkerTok{)}\NormalTok{ get iface   }\KeywordTok{do.}\NormalTok{ rc   }\KeywordTok{return.}
\KeywordTok{elseif.}\NormalTok{  ilist}\KeywordTok{=.} \KeywordTok{".}\NormalTok{iface }\KeywordTok{,} \KeywordTok{;}\NormalTok{locsfx\_ajod}\DecValTok{\_} \KeywordTok{;}\NormalTok{SO}\DecValTok{\_\_}\NormalTok{JODobj}
\NormalTok{         erase}\DecValTok{\_\_}\NormalTok{SO}\DecValTok{\_\_}\NormalTok{JODobj nl}\DecValTok{\_\_}\NormalTok{SO}\DecValTok{\_\_}\NormalTok{JODobj }\KeywordTok{i.} \DecValTok{4}
\NormalTok{         badrc\_ajod}\DecValTok{\_}\NormalTok{ rc}\KeywordTok{=.} \DecValTok{0} \DecValTok{8}\NormalTok{ get }\KeywordTok{/:\textasciitilde{}} \KeywordTok{\textasciitilde{}.}\NormalTok{ilist  }\KeywordTok{do.}\NormalTok{ rc }\KeywordTok{return.}
\KeywordTok{elseif.}  \DecValTok{0}\KeywordTok{=\#}\NormalTok{txt}\KeywordTok{=.} \KeywordTok{>}\DecValTok{1}\KeywordTok{\{}\NormalTok{rc }\KeywordTok{do.}\NormalTok{ jderr\_ajod}\DecValTok{\_} \StringTok{\textquotesingle{}no interface words\textquotesingle{}} \KeywordTok{return.}
\KeywordTok{elseif.do.}
\NormalTok{   ctl fuserows }\KeywordTok{>\&.>} \KeywordTok{<"}\DecValTok{1} \KeywordTok{|:} \RegionMarkerTok{((}\KeywordTok{\#}\NormalTok{txt}\RegionMarkerTok{)}\KeywordTok{\#,:}\NormalTok{cpx}\RegionMarkerTok{)} \KeywordTok{,\&.>}\NormalTok{ txt}
\KeywordTok{end.}
\RegionMarkerTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{indexwraplatex}\AlertTok{=:}\index{indexwraplatex@\texttt{indexwraplatex}} \DecValTok{4} \RegionMarkerTok{: 0}

\CommentTok{NB.*indexwraplatex v{-}{-} insert index commands and handle spurious blanks.}
\CommentTok{NB.}
\CommentTok{NB. dyad:  clLatex =. paIndex indexwraplatex clLatex}

\NormalTok{ltx}\KeywordTok{=.} \KeywordTok{]\textasciigrave{}}\NormalTok{indexgrouptex}\KeywordTok{@.}\RegionMarkerTok{(}\DecValTok{1} \KeywordTok{{-}:} \KeywordTok{x}\RegionMarkerTok{)} \KeywordTok{;}\NormalTok{ tlf}\KeywordTok{\&.>} \KeywordTok{y} \KeywordTok{{-}.} \KeywordTok{a:}

\CommentTok{NB. wrap prefix final LaTeX}
\NormalTok{wpfx}\KeywordTok{=.} \StringTok{\textquotesingle{}\textbackslash{}AlertTok\{\textquotesingle{}}\KeywordTok{,}\NormalTok{WRAPLEAD}\KeywordTok{,}\StringTok{\textquotesingle{}\}\textquotesingle{}}

\CommentTok{NB. convert wrap marks to LaTeX fragments {-} handle trailing blank first}
\NormalTok{ltx}\KeywordTok{=.} \RegionMarkerTok{(}\StringTok{\textquotesingle{}\#\textquotesingle{}}\KeywordTok{,}\NormalTok{WRAPPREFIXTEX}\KeywordTok{,}\StringTok{\textquotesingle{} \textquotesingle{}}\KeywordTok{,}\StringTok{\textquotesingle{}\#\textquotesingle{}}\KeywordTok{,}\NormalTok{wpfx}\RegionMarkerTok{)}\NormalTok{ changestr ltx}
\NormalTok{ltx}\KeywordTok{=.} \RegionMarkerTok{(}\StringTok{\textquotesingle{}\#\textquotesingle{}}\KeywordTok{,}\NormalTok{WRAPPREFIXTEX}\KeywordTok{,}\StringTok{\textquotesingle{}\#\textquotesingle{}}\KeywordTok{,}\NormalTok{wpfx}\RegionMarkerTok{)}\NormalTok{ changestr ltx}

\CommentTok{NB. remove spurious normal token blanks}
\NormalTok{sprb}\KeywordTok{=.}\NormalTok{ wpfx}\KeywordTok{,}\StringTok{\textquotesingle{}\textbackslash{}NormalTok\{\textquotesingle{}}
\RegionMarkerTok{(}\StringTok{\textquotesingle{}\#\textquotesingle{}}\KeywordTok{,}\NormalTok{sprb}\KeywordTok{,}\StringTok{\textquotesingle{} \#\textquotesingle{}}\KeywordTok{,}\NormalTok{sprb}\RegionMarkerTok{)}\NormalTok{ changestr ltx}
\RegionMarkerTok{)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{NB. require \textquotesingle{}jod\textquotesingle{} !(*)=. badrc\_ajod\_ get HEADEND\_ajodmake\_ GROUP\_ajod\_}
\KeywordTok{if.}\NormalTok{ badrc\_ajod}\DecValTok{\_}\NormalTok{ hdr}\KeywordTok{=.}\NormalTok{ GROUP\_ajod}\DecValTok{\_}\NormalTok{ get }\KeywordTok{y} \KeywordTok{do.}\NormalTok{ hdr }\KeywordTok{return.} \KeywordTok{end.}
...
\CommentTok{NB. require \textquotesingle{}jod\textquotesingle{} !(*)=. get MACRO\_ajod\_}
\StringTok{\textquotesingle{}rc post\textquotesingle{}}\KeywordTok{=.}  \DecValTok{2} \KeywordTok{\{.}\NormalTok{ MACRO\_ajod}\DecValTok{\_}\NormalTok{ get }\StringTok{\textquotesingle{}POST\_\textquotesingle{}}\KeywordTok{,y} \KeywordTok{{-}.}\StringTok{\textquotesingle{} \textquotesingle{}}
...
\CommentTok{NB. require \textquotesingle{}jod\textquotesingle{} !(*)=. badrc\_ajod\_ get gdeps grp}
...
\CommentTok{NB. require \textquotesingle{}jod\textquotesingle{} !(*)=. WORD\_ajod\_ NVTABLE\_ajod\_ badrc\_ajod\_ get wttext\_\_MK\_\_JODobj}
\KeywordTok{if.}\NormalTok{ badrc\_ajod}\DecValTok{\_}\NormalTok{ src}\KeywordTok{=.} \RegionMarkerTok{(}\NormalTok{WORD\_ajod}\DecValTok{\_}\KeywordTok{,}\NormalTok{NVTABLE\_ajod}\DecValTok{\_}\RegionMarkerTok{)}\NormalTok{ get }\KeywordTok{y} \KeywordTok{do.}\NormalTok{ src }\KeywordTok{return.} \KeywordTok{end.}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{setifacesummary}\AlertTok{=:}\index{setifacesummary@\texttt{setifacesummary}} \DecValTok{4} \RegionMarkerTok{: 0}

\CommentTok{NB.*setifacesummary v{-}{-} replace markdown interface summary tag with text.}
\CommentTok{NB.}
\CommentTok{NB. dyad:  cl =. clGname setifacesummary clMd}

\RegionMarkerTok{(}\NormalTok{JLINSERTIFACEMD beforestr }\KeywordTok{y}\RegionMarkerTok{)}\KeywordTok{,}\RegionMarkerTok{(}\NormalTok{ifacemarkd }\KeywordTok{x}\RegionMarkerTok{)}\KeywordTok{,}\NormalTok{JLINSERTIFACEMD afterstr }\KeywordTok{y}
\RegionMarkerTok{)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{NB. replace troublesome \_ in names}
\NormalTok{hlwords}\KeywordTok{=.}\NormalTok{ UBARSUB}\KeywordTok{\&}\NormalTok{charsub}\KeywordTok{\&.>} \KeywordTok{x}

\CommentTok{NB. any \_ chars are expanded to \textbackslash{}\_ at this stage}
\NormalTok{wnames}\KeywordTok{=.} \StringTok{\textquotesingle{}\#\_\#\textbackslash{}\_\textquotesingle{}}\KeywordTok{\&}\NormalTok{changestr }\KeywordTok{\&.>} \KeywordTok{x}
\NormalTok{targs}\KeywordTok{=.} \RegionMarkerTok{(}\KeywordTok{<}\StringTok{\textquotesingle{}\textbackslash{}NormalTok\{\textquotesingle{}}\RegionMarkerTok{)} \KeywordTok{,\&.>}\NormalTok{ wnames }\KeywordTok{,\&.>} \KeywordTok{<}\StringTok{\textquotesingle{}\}\textbackslash{}AlertTok\{=:\}\textbackslash{}index\textquotesingle{}}

\NormalTok{labels}\KeywordTok{=.} \RegionMarkerTok{(}\KeywordTok{<}\StringTok{\textquotesingle{}\}\}\textbackslash{}AlertTok\{=:\}\textbackslash{}phantomsection\textbackslash{}label\{\textquotesingle{}}\KeywordTok{,}\NormalTok{IFCPFX}\RegionMarkerTok{)}\KeywordTok{,\&.>}\NormalTok{ hlwords }\KeywordTok{,\&.>} \KeywordTok{<}\StringTok{\textquotesingle{}\}\textbackslash{}index\textquotesingle{}}
\NormalTok{rstrs}\KeywordTok{=.} \RegionMarkerTok{(}\KeywordTok{<}\StringTok{\textquotesingle{}\textbackslash{}hypertarget\{\textquotesingle{}}\RegionMarkerTok{)} \KeywordTok{,\&.>}\NormalTok{ hlwords }\KeywordTok{,\&.>} \RegionMarkerTok{(}\KeywordTok{<}\StringTok{\textquotesingle{}\}\{\textbackslash{}NormalTok\{\textquotesingle{}}\RegionMarkerTok{)} \KeywordTok{,\&.>}\NormalTok{ wnames }\KeywordTok{,\&.>}\NormalTok{ labels}

\CommentTok{NB. delimter character cannot be in text}
\KeywordTok{assert.} \KeywordTok{{-}.}\StringTok{\textquotesingle{}\#\textquotesingle{}} \KeywordTok{e.} \KeywordTok{;}\NormalTok{targs}\KeywordTok{,}\NormalTok{rstrs}

\NormalTok{chgs}\KeywordTok{=.} \KeywordTok{;}\StringTok{\textquotesingle{}\#\textquotesingle{}} \KeywordTok{,\&.>}\NormalTok{ targs }\KeywordTok{,.}\NormalTok{ rstrs}
...
\begin{Shaded}
\begin{Highlighting}[]
\hypertarget{setjodliterate}{\NormalTok{setjodliterate}}\AlertTok{=:}\phantomsection\label{ifc:setjodliterate}\index{setjodliterate@\texttt{setjodliterate}} \DecValTok{3} \RegionMarkerTok{: 0}

\CommentTok{NB.*setjodliterate v{-}{-} prepare LaTeX processing {-} sets out directory writes preamble.}
\CommentTok{NB.}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{wordlatex}\AlertTok{=:}\index{wordlatex@\texttt{wordlatex}} \DecValTok{3} \RegionMarkerTok{: 0}

\CommentTok{NB.*wordlatex v{-}{-} LaTeX from word list.}
\CommentTok{NB.}
\CommentTok{NB. monad:  clLatex =. wordlatex blclWords}

\CommentTok{NB. require \textquotesingle{}jod\textquotesingle{} !(*) badcl\_ajod\_}
\KeywordTok{if.}\NormalTok{ badcl\_ajod}\DecValTok{\_}\NormalTok{ mtxt}\KeywordTok{=.}\NormalTok{ markdfrwords }\KeywordTok{y} \KeywordTok{do.}\NormalTok{ mtxt }\KeywordTok{return.}
\KeywordTok{elseif.} \KeywordTok{\#}\NormalTok{mtxt }\KeywordTok{do.} \DecValTok{1}\NormalTok{ indexwraplatex }\KeywordTok{<}\NormalTok{latexfrmarkd mtxt}
\KeywordTok{elseif.do.} \StringTok{\textquotesingle{}\textquotesingle{}}
\KeywordTok{end.}
\RegionMarkerTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\hypertarget{wordlit}{\NormalTok{wordlit}}\AlertTok{=:}\phantomsection\label{ifc:wordlit}\index{wordlit@\texttt{wordlit}} \DecValTok{3} \RegionMarkerTok{: 0}

\CommentTok{NB.*wordlit v{-}{-} make latex from word list (y).}
\CommentTok{NB.}
\CommentTok{NB. monad:  (paRc ; blclTeXfiles) =. wordlit blclWords}
\CommentTok{NB.}
\CommentTok{NB.   wordlit \textquotesingle{}jodliterate\textquotesingle{}}
\CommentTok{NB.}
\CommentTok{NB. dyad:  (paRc ; blclTeXfiles) =. paOw wordlit blclWords}
\CommentTok{NB.}
\CommentTok{NB.   NB. do not overwrite root tex {-} allows for latex tweaking}
\CommentTok{NB.   0 wordlit \textquotesingle{}jodliterate\textquotesingle{}}

\DecValTok{1}\NormalTok{ wordlit }\KeywordTok{y}
\KeywordTok{:}
\CommentTok{NB. require \textquotesingle{}jod\textquotesingle{} !(*)=. badrc\_ajod\_ badcl\_ajod\_ checknames\_ajod\_}
\KeywordTok{try.}

\KeywordTok{if.} \DecValTok{3}\KeywordTok{\textasciitilde{}:}\RegionMarkerTok{(}\DecValTok{4}\KeywordTok{!:}\DecValTok{0}\RegionMarkerTok{)} \KeywordTok{<}\StringTok{\textquotesingle{}badrc\_ajod\_\textquotesingle{}} \KeywordTok{do.} \DecValTok{0}\KeywordTok{;}\StringTok{\textquotesingle{}!error: jod is not loaded\textquotesingle{}} \KeywordTok{return.} \KeywordTok{end.}
\KeywordTok{if.} \DecValTok{0}\KeywordTok{=\#}\NormalTok{JLDIRECTORY  }\KeywordTok{do.} \DecValTok{0}\KeywordTok{;}\StringTok{\textquotesingle{}!error: working directory is not set\textquotesingle{}} \KeywordTok{return.} \KeywordTok{end.}

\CommentTok{NB. only valid jod names}
\KeywordTok{if.}\NormalTok{ badrc\_ajod}\DecValTok{\_}\NormalTok{ wlist}\KeywordTok{=.}\NormalTok{ checknames\_ajod}\DecValTok{\_} \KeywordTok{y} \KeywordTok{do.}\NormalTok{ wlist }\KeywordTok{return.} \KeywordTok{end.}

\CommentTok{NB. use first name on word list for tex file names}
\NormalTok{texname}\KeywordTok{=.} \KeywordTok{;}\DecValTok{0}\KeywordTok{\{}\NormalTok{wlist}\KeywordTok{=.} \KeywordTok{\}.}\NormalTok{wlist}

\CommentTok{NB. make latex}
\KeywordTok{if.}\NormalTok{ badcl\_ajod}\DecValTok{\_}\NormalTok{ wltx}\KeywordTok{=.}\NormalTok{ wordlatex wlist }\KeywordTok{do.}\NormalTok{ wltx }\KeywordTok{return.} \KeywordTok{end.}

\CommentTok{NB. root .tex file}
\NormalTok{wdir}\KeywordTok{=.}\NormalTok{ JLDIRECTORY}
\NormalTok{jlroot}\KeywordTok{=.}\NormalTok{ wdir}\KeywordTok{,}\NormalTok{texname}\KeywordTok{,}\StringTok{\textquotesingle{}.tex\textquotesingle{}}
\KeywordTok{if.}\NormalTok{ chroot}\KeywordTok{=.} \KeywordTok{x} \KeywordTok{{-}:} \DecValTok{1} \KeywordTok{do.}
\NormalTok{  root}\KeywordTok{=.} \RegionMarkerTok{(}\StringTok{\textquotesingle{}/\textasciitilde{}\#\textasciitilde{}texname\textasciitilde{}\#\textasciitilde{}/\textquotesingle{}}\KeywordTok{,}\NormalTok{texname}\RegionMarkerTok{)}\NormalTok{ changestr JLWORDLITTEX}
  \RegionMarkerTok{(}\NormalTok{toJ root}\RegionMarkerTok{)}\NormalTok{ writeas jlroot}
\KeywordTok{end.}

\CommentTok{NB. group build batch script {-} latex utils that compile generated files}
\NormalTok{jlbuildtex}\KeywordTok{=.} \RegionMarkerTok{(}\StringTok{\textquotesingle{}/\textasciitilde{}\#\textasciitilde{}group\textasciitilde{}\#\textasciitilde{}/\textquotesingle{}}\KeywordTok{,}\NormalTok{texname}\RegionMarkerTok{)}\NormalTok{ changestr JLBUILDTEX}
\RegionMarkerTok{(}\NormalTok{toJ jlbuildtex}\RegionMarkerTok{)}\NormalTok{ writeas jlbuildbat}\KeywordTok{=.}\NormalTok{ wdir}\KeywordTok{,}\NormalTok{texname}\KeywordTok{,}\StringTok{\textquotesingle{}.bat\textquotesingle{}}

\CommentTok{NB. source code .tex {-} return file names}
\CommentTok{NB. gltx=. iwords setifacetargs gltx}
\RegionMarkerTok{(}\NormalTok{toJ wltx}\RegionMarkerTok{)}\NormalTok{ writeas jlcode}\KeywordTok{=.}\NormalTok{ wdir}\KeywordTok{,}\NormalTok{texname}\KeywordTok{,}\NormalTok{JLCODEFILE}
\NormalTok{ok\_ajod}\DecValTok{\_} \RegionMarkerTok{(}\KeywordTok{{-}.}\NormalTok{chroot}\RegionMarkerTok{)} \KeywordTok{\}.}\NormalTok{ jlroot}\KeywordTok{;}\NormalTok{jlcode}\KeywordTok{;}\NormalTok{jlbuildbat}

\KeywordTok{catchd.}
  \DecValTok{0}\KeywordTok{;}\StringTok{\textquotesingle{}!error: (wordlit) failure {-} last J error {-}>\textquotesingle{}}\KeywordTok{;}\DecValTok{13}\KeywordTok{!:}\DecValTok{12} \StringTok{\textquotesingle{}\textquotesingle{}}
\KeywordTok{end.}
\RegionMarkerTok{)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{NB. {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\CommentTok{NB. THISPANDOC      NB. full pandoc path {-} use (pandoc) if on shell path}
\CommentTok{NB. formifacetex    NB. formats hyperlinked and highlighted interface words}
\CommentTok{NB. grplit          NB. make latex for group (y)}
\CommentTok{NB. ifacesection    NB. interface section summary string}
\CommentTok{NB. ifc             NB. format interface comment text}
\CommentTok{NB. setjodliterate  NB. prepare LaTeX processing {-} sets out directory writes preamble}
\CommentTok{NB. wordlit         NB. make latex from word list (y)}
\RegionMarkerTok{)}
...
\RegionMarkerTok{(}\DecValTok{3} \RegionMarkerTok{: 0)} \StringTok{\textquotesingle{}\textquotesingle{}}
\KeywordTok{if.} \KeywordTok{+./@}\RegionMarkerTok{(}\StringTok{\textquotesingle{}pandoc\textquotesingle{}}\KeywordTok{\&E.}\RegionMarkerTok{)}\NormalTok{ panver}\KeywordTok{=.} \KeywordTok{;}\DecValTok{0}\KeywordTok{\{} \KeywordTok{<;.}\NormalTok{\_}\DecValTok{2}\NormalTok{ tlf }\RegionMarkerTok{(}\NormalTok{shell THISPANDOC}\KeywordTok{,}\StringTok{\textquotesingle{} {-}{-}version\textquotesingle{}}\RegionMarkerTok{)} \KeywordTok{{-}.}\NormalTok{ CR }\KeywordTok{do.}
\NormalTok{  smoutput }\StringTok{\textquotesingle{}NOTE: adjust pandoc path if version (\textquotesingle{}}\KeywordTok{,}\NormalTok{panver}\KeywordTok{,}\StringTok{\textquotesingle{}) is not >= 2.9.1.1\textquotesingle{}}
\KeywordTok{else.}
\NormalTok{  smoutput }\StringTok{\textquotesingle{}ERROR: pandoc not set {-} adjust THISPANDOC\textquotesingle{}}
\NormalTok{  smoutput }\StringTok{\textquotesingle{}THISPANDOC\_ajodliterate\_=: \textquotesingle{}\textquotesingle{}pandoc\textquotesingle{}\textquotesingle{} NB. when pandoc on path\textquotesingle{}}
\KeywordTok{end.}
\RegionMarkerTok{)}
\end{Highlighting}
\end{Shaded}
