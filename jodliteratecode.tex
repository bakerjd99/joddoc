...
\NormalTok{IFACEWORDSjodliterate}\AlertTok{=:}\index{IFACEWORDSjodliterate@\texttt{IFACEWORDSjodliterate}} \KeywordTok{<;.}\NormalTok{\_}\DecValTok{1} \StringTok{\textquotesingle{} grplit setjodliterate ifacesection\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{THISPANDOC}\AlertTok{=:}\index{THISPANDOC@\texttt{THISPANDOC}} \StringTok{\textquotesingle{}"C:\textbackslash{}Program Files\textbackslash{}Pandoc\textbackslash{}pandoc"\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{grplit}\AlertTok{=:}\index{grplit@\texttt{grplit}} \DecValTok{3} \RegionMarkerTok{: 0}
...
\NormalTok{group}\KeywordTok{=.} \KeywordTok{y} \KeywordTok{{-}.} \StringTok{\textquotesingle{} \textquotesingle{}}
\KeywordTok{if.}\NormalTok{ badrc\_ajod}\DecValTok{\_}\NormalTok{ gdoc}\KeywordTok{=.} \DecValTok{2} \DecValTok{9}\NormalTok{ get group }\KeywordTok{do.}\NormalTok{ gdoc }\KeywordTok{return.} \KeywordTok{end.}

\CommentTok{NB. latex from any group document markdown}
\NormalTok{hype}\KeywordTok{=.} \DecValTok{0}
...
\NormalTok{  gdoc}\KeywordTok{=.}\NormalTok{ latexfrmarkd gdoc}
  \KeywordTok{if.}\NormalTok{ badrc\_ajod}\DecValTok{\_}\NormalTok{ glist}\KeywordTok{=.}\NormalTok{ grp group }\KeywordTok{do.}\NormalTok{ glist }\KeywordTok{return.} \KeywordTok{end.}
...
\NormalTok{    hype}\KeywordTok{=.} \DecValTok{1}  \CommentTok{NB. hyperlinks set}
  \KeywordTok{end.}
\KeywordTok{end.}
...
\NormalTok{ohd}\KeywordTok{=.} \RegionMarkerTok{(}\StringTok{\textquotesingle{}/\textasciitilde{}\#\textasciitilde{}group\textasciitilde{}\#\textasciitilde{}/\textquotesingle{}}\KeywordTok{,}\NormalTok{alltrim }\KeywordTok{y}\RegionMarkerTok{)}\NormalTok{ changestr JLOVIEWTEX}
...
\KeywordTok{if.}\NormalTok{ hype }\KeywordTok{do.}\NormalTok{ gltx}\KeywordTok{=.}\NormalTok{ iwords setifacetargs gltx }\KeywordTok{end.}
...
\NormalTok{ok\_ajod}\DecValTok{\_} \RegionMarkerTok{(}\KeywordTok{{-}.}\NormalTok{chroot}\RegionMarkerTok{)} \KeywordTok{\}.}\NormalTok{ jlroot}\KeywordTok{;}\NormalTok{jltitle}\KeywordTok{;}\NormalTok{jloview}\KeywordTok{;}\NormalTok{jlcode}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ifacesection}\AlertTok{=:}\index{ifacesection@\texttt{ifacesection}} \DecValTok{3} \RegionMarkerTok{: 0}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{setjodliterate}\AlertTok{=:}\index{setjodliterate@\texttt{setjodliterate}} \DecValTok{3} \RegionMarkerTok{: 0}
