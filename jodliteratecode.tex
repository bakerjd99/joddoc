...
\begin{Shaded}
\begin{Highlighting}[]
\hypertarget{formifacetex}{\NormalTok{formifacetex}}\AlertTok{=:}\index{formifacetex@\texttt{formifacetex}} \DecValTok{3} \RegionMarkerTok{: 0}
...
\NormalTok{      gdoc}\KeywordTok{=.} \RegionMarkerTok{(}\StringTok{\textquotesingle{}/\textquotesingle{}}\KeywordTok{,}\NormalTok{JLINSERTIFACEMD}\KeywordTok{,}\StringTok{\textquotesingle{}/\textquotesingle{}}\KeywordTok{,}\NormalTok{ifacemarkd group}\RegionMarkerTok{)}\NormalTok{ changestr gdoc}
    \KeywordTok{end.}
...
\begin{Shaded}
\begin{Highlighting}[]
\hypertarget{ifc}{\NormalTok{ifc}}\AlertTok{=:}\index{ifc@\texttt{ifc}} \DecValTok{3} \RegionMarkerTok{: 0}
...
\begin{Shaded}
\begin{Highlighting}[]
\hypertarget{wordlit}{\NormalTok{wordlit}}\AlertTok{=:}\index{wordlit@\texttt{wordlit}} \DecValTok{3} \RegionMarkerTok{: 0}
