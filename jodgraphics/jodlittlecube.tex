...
\begin{scope}[every node/.append style={yslant=-0.5},yslant=-0.5]
  ...
  \node at (1.5,1.5) {\textcolor{red}{J}};%{\includegraphics[height=1.0cm]{jred.png}};
%  \node at (1.5,2.5) {};
%  \node at (2.5,2.5) {};
%  \node at (0.5,1.5) {};
%  \node at (1.5,1.5) {O};%{\textcolor{red}{O}};
%  \node at (2.5,1.5) {};
%  \node at (0.5,0.5) {};
%  \node at (1.5,0.5) {};
...
%  \node at (3.5,-1.5) {\includegraphics[height=1.0cm]{jblue.png}};
  \node at  (4.5,-1.5) {\textcolor{RoyalBlue}{D}}; %{\textcolor{cyan}{O}}
...
%  \node at (3.5,0.5) {};
%  \node at (4.5,2.5) {};
 \node at (4.5,1.5) {\textcolor{PineGreen}{O}};%{\textcolor{ForestGreen}{O}}
%  \node at (4.5,0.5) {};
%  \node at (5.5,2.5) {};
