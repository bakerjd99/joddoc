...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{JODVMD}\AlertTok{=:}\index{JODVMD@\texttt{JODVMD}}\StringTok{'0.9.90'}\FunctionTok{;}\NormalTok{1}\DecValTok{5}\FunctionTok{;}\StringTok{'3 Nov 2012 15:32:48'}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{NB. J name class}
\NormalTok{nc}\AlertTok{=:}\index{nc@\texttt{nc}}\NormalTok{4}\OtherTok{!:}\NormalTok{0}
\end{Highlighting}
\end{Shaded}
