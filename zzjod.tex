...
\RegionMarkerTok{)}\KeywordTok{=.}\RegionMarkerTok{)}\KeywordTok{=.}\NormalTok{td rxs uses\textquotesingle{}}
...
\NormalTok{JODVMD}\AlertTok{=:}\index{JODVMD@\texttt{JODVMD}} \StringTok{\textquotesingle{}1.0.1 {-} dev\textquotesingle{}}\KeywordTok{;}\DecValTok{5}\KeywordTok{;}\StringTok{\textquotesingle{}25 Mar 2020 14:23:47\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\RegionMarkerTok{)}\KeywordTok{=.}\RegionMarkerTok{)}\KeywordTok{=.m}\NormalTok{ Files}\KeywordTok{\textbackslash{}}\NormalTok{Internet Explorer}\KeywordTok{\textbackslash{}}\NormalTok{IEXPLORE}\KeywordTok{.}\NormalTok{EXE}\KeywordTok{"}\NormalTok{\textquotesingle{}}
...
\NormalTok{badcl}\AlertTok{=:}\index{badcl@\texttt{badcl}} \KeywordTok{{-}.@}\RegionMarkerTok{(}\DecValTok{2}\KeywordTok{\&=@}\RegionMarkerTok{(}\DecValTok{3}\KeywordTok{!:}\DecValTok{0}\RegionMarkerTok{))} \RegionMarkerTok{(}\KeywordTok{+.}\RegionMarkerTok{)} \KeywordTok{1:} \KeywordTok{<} \KeywordTok{[:} \KeywordTok{\#} \KeywordTok{$}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{badfl}\AlertTok{=:}\index{badfl@\texttt{badfl}} \KeywordTok{[:} \RegionMarkerTok{(}\KeywordTok{{-}.}\RegionMarkerTok{)} \DecValTok{8}\KeywordTok{"}\NormalTok{\_ }\KeywordTok{=} \DecValTok{3}\KeywordTok{!:}\DecValTok{0}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{badil}\AlertTok{=:}\index{badil@\texttt{badil}} \KeywordTok{{-}.@}\RegionMarkerTok{(((}\KeywordTok{[:} \KeywordTok{\#} \KeywordTok{$}\RegionMarkerTok{)} \RegionMarkerTok{(}\KeywordTok{e.}\RegionMarkerTok{)} \DecValTok{0} \DecValTok{1}\KeywordTok{"}\NormalTok{\_}\RegionMarkerTok{)} \RegionMarkerTok{(}\KeywordTok{*.}\RegionMarkerTok{)} \DecValTok{3}\KeywordTok{!:}\DecValTok{0} \RegionMarkerTok{(}\KeywordTok{e.}\RegionMarkerTok{)} \DecValTok{1} \DecValTok{4}\KeywordTok{"}\NormalTok{\_}\RegionMarkerTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{badrc}\AlertTok{=:}\index{badrc@\texttt{badrc}} \KeywordTok{[:} \RegionMarkerTok{(}\KeywordTok{{-}.}\RegionMarkerTok{)} \KeywordTok{1:} \KeywordTok{{-}:} \KeywordTok{[:} \KeywordTok{>} \KeywordTok{\{.}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{nowfd}\AlertTok{=:}\index{nowfd@\texttt{nowfd}} \RegionMarkerTok{(}\KeywordTok{[:} \RegionMarkerTok{(}\DecValTok{0} \DecValTok{100} \DecValTok{100}\KeywordTok{\&\#.}\RegionMarkerTok{)} \KeywordTok{3:} \KeywordTok{\{.} \KeywordTok{]}\RegionMarkerTok{)} \KeywordTok{+} \RegionMarkerTok{(}\KeywordTok{[:} \RegionMarkerTok{(}\DecValTok{24} \DecValTok{60} \DecValTok{60}\KeywordTok{\&\#.}\RegionMarkerTok{)} \KeywordTok{3:} \KeywordTok{\}.} \KeywordTok{]}\RegionMarkerTok{)} \KeywordTok{\%} \DecValTok{86400}\KeywordTok{"}\NormalTok{\_}
\end{Highlighting}
\end{Shaded}
