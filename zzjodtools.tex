...
\NormalTok{JODTOOLSVMD}\AlertTok{=:}\index{JODTOOLSVMD@\texttt{JODTOOLSVMD}}\StringTok{'0.9.90'}\FunctionTok{;}\NormalTok{1}\DecValTok{5}\FunctionTok{;}\StringTok{'3 Nov 2012 15:32:51'}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{if.} \NormalTok{r }\KeywordTok{do.}
  ...
  \KeywordTok{if.} \NormalTok{wex }\FunctionTok{<}\StringTok{'CLASSAUTHOR'} \KeywordTok{do.}
    \KeywordTok{if.} \FunctionTok{-.}\NormalTok{badcl CLASSAUTHOR }\KeywordTok{do.} \NormalTok{test}\CharTok{=.} \NormalTok{test}\FunctionTok{,}\NormalTok{dl}\FunctionTok{,}\StringTok{'\{~A~\}'}\FunctionTok{,}\NormalTok{dl}\FunctionTok{,}\NormalTok{CLASSAUTHOR }\KeywordTok{end.}
  \KeywordTok{end.}
